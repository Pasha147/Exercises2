      ...
      <header className="sticky top-0 z-10">
        <section className="text-right items-center max-w-4xl mx-auto p-2 ">
          <nav
            className={`${
              burMenu
                ? `absolute w-[80%] h-[80vh] flex flex-col [&>a]:text-right

                sm:relative sm:w-auto sm:h-auto `
                : `hidden `
            }
               sm:inline-block m-0-1 [&>a]:px-1 [&>a]:border-r-2 [&>a]:border-slate-600 [&>a]:inline-block md:[&>a]:min-w-24 [&>a]:text-center [&>a]:opacity-70 [&>a:hover]:opacity-100 [&>a:hover]:[text-shadow:_3px_4px_7px_rgba(255,255,255,0.77)]`}
          >
            <a href="#home">Home</a>
